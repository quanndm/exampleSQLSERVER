...
*	11.TB tbl_author(id, name)
*	12.TB tbl_User_Role(id, role)
*	13.TB tbl_User(id, role_id, username, password)
*/
...
(
	...
	EMAIL NVARCHAR(50) NOT NULL,
	[ADDRESS] NVARCHAR(50) NULL,
	--REPRESENTATIVE/ID_USER/NAME... NVARCHAR(50) NOT NULL --(tên người đại diện ) 
)
GO
...
(
	...
	Year_Of_manufatore VARCHAR(4) NULL,
